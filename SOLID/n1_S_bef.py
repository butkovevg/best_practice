...
Один класс имеет только одну зону ответственности(Ограничен своей задачей).
Не нужно создавать МЕГАКЛАСС, который делает все:
На примере
https://www.youtube.com/watch?v=C8fhcHqnqyI&t
